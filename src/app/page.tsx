...
export default function Home() {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="relative text-white pt-24 pb-16 bg-gradient-to-br from-accent-light to-accent-dark animate-gradient shadow-lg border-b-4 border-accent animate-fadeIn">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h1 className="text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl mb-8 leading-tight max-w-prose mx-auto drop-shadow-xl heading-gradient-underline">
        ...
        {/* About Section */}
        <section id="about" className="py-12 bg-gray-50 dark:bg-neutral-800 animate-fadeIn">
        ...
        {/* Mission Section */}
        <section id="mission" className="py-20 bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral animate-fadeIn">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
            <h2 className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-accent mb-4 heading-gradient-underline">Our Mission</h2>
            ...
            <p className="text-lg text-secondary leading-relaxed max-w-3xl mx-auto">We promote best practices, protect client welfare, align with legal standards, and uphold ABA integrity.</p>
        ...
        {/* Mandate Section */}
        <section id="mandate" className="py-20 bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral animate-fadeIn">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-white mb-6 heading-gradient-underline">Developing and Disseminating Best Practices</h2>
            <p className="text-lg text-white leading-relaxed max-w-3xl mx-auto drop-shadow">We develop and share guidelines for ethical AI in ABA, collaborating with professionals and evolving with feedback and technology.</p>
          </div>
        </section>

        {/* Why Section */}
        <section id="why" className="py-20 bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral animate-fadeIn">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-accent mb-6 heading-gradient-underline">Navigating the Intersection of AI and ABA</h2>
        ...
        {/* Principles Section */}
        <section id="principles" className="py-24 bg-white dark:bg-neutral-900 border-b-4 border-primary animate-fadeIn">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-accent text-center mb-10 heading-gradient-underline">Guiding Principles for AI in ABA</h2>
            <p className="text-center text-lg text-neutral dark:text-light mb-16 max-w-3xl mx-auto leading-relaxed">Our developing guidelines are built upon foundational principles designed to ensure the ethical and effective use of AI in ABA service delivery. Key areas of focus include:</p>
            <div className="grid grid-cols-1 gap-10 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Human Collaboration & Oversight icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Human Collaboration & Oversight</h3>
                  <p className="text-secondary text-sm leading-relaxed">Ensuring AI supports, but does not replace, clinical judgment and accountability.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Transparency & Explainability icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Transparency & Explainability</h3>
                  <p className="text-secondary text-sm leading-relaxed">Promoting clear disclosure about AI use to clients and practitioners.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Privacy & Data Security icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Privacy & Data Security</h3>
                  <p className="text-secondary text-sm leading-relaxed">Upholding rigorous standards for protecting sensitive information (HIPAA, FERPA, etc.).</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Accountability icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Accountability</h3>
                  <p className="text-secondary text-sm leading-relaxed">Defining clear roles and responsibilities for AI development, deployment, and use.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Safety & Accuracy icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Safety & Accuracy</h3>
                  <p className="text-secondary text-sm leading-relaxed">Continuously monitoring AI systems for quality, accuracy, and safety.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Equity & Bias Mitigation icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Equity & Bias Mitigation</h3>
                  <p className="text-secondary text-sm leading-relaxed">Actively working to identify and minimize bias in AI development and deployment.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Evaluation & Continuous Improvement icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Evaluation & Continuous Improvement</h3>
                  <p className="text-secondary text-sm leading-relaxed">Committing to ongoing assessment and refinement of AI tools and guidelines.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Responsible Research Practices icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Responsible Research Practices</h3>
                  <p className="text-secondary text-sm leading-relaxed">Guiding the ethical use of AI in behavior analytic research.</p>
                </div>
              </Card>
              <Card className="bg-light dark:bg-neutral border-2 border-accent p-6 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition flex items-start space-x-4">
                <div className="flex-shrink-0 text-accent">
                  ...
                  <span className="sr-only">Digital Literacy & Training icon</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral dark:text-light mb-1 max-w-prose">Digital Literacy & Training</h3>
                  <p className="text-secondary text-sm leading-relaxed">Encouraging competence and education in AI technologies for practitioners.</p>
                </div>
              </Card>
            </div>
            <div className="text-center mt-16">
              <span className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-secondary opacity-90 cursor-not-allowed shadow-lg">
                Ethical Guidelines (Coming Soon)
              </span>
            </div>
          </div>
        ...
        {/* Audience Section */}
        <section id="audience" className="py-20 bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral animate-fadeIn">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-primary mb-6 heading-gradient-underline">Who Are These Guidelines For?</h2>
        ...
        {/* Contact/CTA Section */}
        <section id="contact" className="py-20 bg-gradient-to-br from-primary via-accent to-secondary dark:from-primary dark:via-neutral dark:to-secondary">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 heading-gradient-underline">Get Involved & Stay Informed</h2>
            <p className="text-lg text-white leading-relaxed mb-10 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="md:flex md:justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="mt-4 text-gray-400 text-sm"><a href="mailto:info@aicaba.org" className="underline hover:text-accent">info@aicaba.org</a></p>
